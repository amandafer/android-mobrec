...
public class PlaceDialogFragment extends DialogFragment{
    ...
    private static final String PLACES_API_BASE = "https://maps.googleapis.com/maps/api/place/photo?";
    private static final String PLACES_API_KEY = "AIzaSyDSOJcf8yI4P4SFKTOi-qh0_aN9RvmzQ4c";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(mPlace != null) {
			...
			String url = PLACES_API_BASE;
			String key = PLACES_API_KEY;
